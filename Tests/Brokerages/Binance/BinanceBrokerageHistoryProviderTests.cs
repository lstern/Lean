    ...
    public partial class BinanceBrokerageTests
    {
        public TestCaseData[] ValidHistory
        {
            get
            {
                ...
                {
                    // valid 
                    new TestCaseData(Symbol.Create("ETHUSD", SecurityType.Crypto, Market.Binance), Resolution.Minute, Time.OneHour, false),
                    new TestCaseData(Symbol.Create("ETHUSD", SecurityType.Crypto, Market.Binance), Resolution.Hour, Time.OneDay, false),
                    new TestCaseData(Symbol.Create("ETHUSD", SecurityType.Crypto, Market.Binance), Resolution.Daily, TimeSpan.FromDays(15), false),
                };
            }
        }
        public TestCaseData[] InvalidHistory
        {
            get
            {
                ...
                {
                    // invalid resolution
                    new TestCaseData(Symbol.Create("ETHUSD", SecurityType.Crypto, Market.Binance), Resolution.Tick, TimeSpan.FromSeconds(15), true),
                    new TestCaseData(Symbol.Create("ETHUSD", SecurityType.Crypto, Market.Binance), Resolution.Second, Time.OneMinute, true),
